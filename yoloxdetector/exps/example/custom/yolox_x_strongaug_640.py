...
if torch.cuda.is_available():
    ...
    print("Cleared CUDA cache and IPC resources before training.")
...
class Exp(BaseExp):
    def __init__(self):
        ...
        # Full (strong) Augmentations. Set all of the probs to 0.0 for no augmentation, to 1.0 for strong (full)
        # augmentation
