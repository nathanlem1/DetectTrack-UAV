...
def make_parser():
    parser = argparse.ArgumentParser("FusionSORTUAV Demo!")
    parser.add_argument("--demo_type", default="webcam", help="demo type, eg. image, video or webcam")
    ...
    parser.add_argument("--benchmark", type=str, default='demo',
                        help="No benchmark is necessary for demo")
    ...
    parser.add_argument("--cmc-method", default="none", type=str,
                        help="cmc method: orb | sparseOptFlow | sift | ecc | none| (file cannot be used for demo!)")
...
def main(exp, args):
    ...
    vis_folder = os.path.join(args.output_dir, args.benchmark, args.experiment_name)
    os.makedirs(vis_folder, exist_ok=True)

    if args.save_result:
        vis_folder = osp.join(vis_folder, args.demo_type + '_tracks')
        os.makedirs(vis_folder, exist_ok=True)
    ...
    if args.demo_type == "image" or args.demo_type == "images":
        image_demo(predictor, vis_folder, current_time, args)
    elif args.demo_type == "video" or args.demo_type == "webcam":
        imageflow_demo(predictor, vis_folder, current_time, args)
    else:
        raise ValueError("Error: Unknown source: " + args.demo_type)
